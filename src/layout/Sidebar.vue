...
export default {
  data () {
    return {
      items: [
        ...
        {
          icon: 'el-icon-DMAlousunguanli iconfont',
          index: '4',
          name: 'DMA及漏损控制',
          subs: [
            {
            ...
            {
              index: 'reportDMADaily',
              route: '/reportDMADaily',
              name: '日报表'
            },
            {
              index: 'reportDMAIndex',
              name: '自定义时段汇总'
            },
            {
              index: 'reportDMADetail',
              name: '自定义时段明细'
            }
          ]
        },
        ...
        /*
        {
          icon: 'el-icon-richangshiwu iconfont',
          index: 'basecharts',
          name: '系统管理',
          subs: [
            {
  ...
  mounted () {
    if (this.$route.path !== '/') {
      // this.$store.commit('add_tabs', {route: '/realTimeMonIndex', name: '测点实时数据', component:'realTimeMonIndex'});
